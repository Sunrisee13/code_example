module.exports = {
  ...
  rules: {
    ...
    'i18next/no-literal-string': ['error', { markupOnly: true, ignoreAttribute: ['as',"variant", 'feature', 'border', 'role', 'to', 'data-testid', 'name', 'alt', 'target', 'justify', 'align', 'direction', 'gap'] }],
